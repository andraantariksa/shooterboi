...
pub fn enqueue_container(world: &mut World, physics: &mut GamePhysics, renderer: &mut Renderer) {
    for (_id, (_container, rb_handle, object_bound)) in
        world.query_mut::<(&Container, &RigidBodyHandle, &ObjectBound)>()
    {
